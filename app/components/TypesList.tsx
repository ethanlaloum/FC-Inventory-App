...
export default function TypesList({ data, onUpdateQuantity, onItemPress, refreshing, onRefresh, type }: StockListProps) {
    ...
    if (type === 'brand') {
      ...
      <TouchableOpacity onPress={() => onItemPress(item)} className="bg-white p-4 mb-2 rounded-lg shadow-sm">
        <View className="flex-row justify-between items-center">
          <View>
            <Text className="font-medium text-gray-800 text-base">{item.product_type}</Text>
